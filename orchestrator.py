...
class Orchestrator(): 
    def __init__(self, 
        ...
        self.transition_manager = TransitionManager(delay_informed_agent = delay_informed_agent, safe_agent = safe_agent)
    ...
    def update(self, env, state, new_state, action_queue = None):
        # Update delay model errors
        self.delay_model.update_errors(env, self.transition_manager.delay_informed_agent.env_model, state, new_state, action_queue)
...
class TransitionManager():
    ...
    def predict(self, augmented_state,  delay_prediction, delay_certainty, deterministic = True):
        ...
        safe_action, _ = self.safe_agent.predict(augmented_state, deterministic= False)
